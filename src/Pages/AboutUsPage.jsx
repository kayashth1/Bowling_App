...
const AboutUsPage = () => {
  ...
  <div className="about-text w-[70%] ml-0 md:ml-[40px]">
    ...
    >
      At our bowling alley, our manager, Rizwan, is dedicated to ensuring an
      exceptional customer experience. With a focus on maintaining our brand&apos;s
      high standards, Rizwan fosters a welcoming atmosphere where fun and
      enjoyment are paramount. His approach to customer relations emphasizes
      personal connections and attentive service. Under his leadership, our
      team of enthusiastic staff members goes above and beyond to ensure every
      guest leaves with a smile, providing top-notch service and creating
